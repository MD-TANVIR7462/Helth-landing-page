function HaveAquestion() {
  return (
    <div className=" relative mx-auto w-full bg-[url(/images/calltoactionbg.png)] text-white  secGap">
      <div className="container relative mx-auto px-4 py-8 sm:py-10 lg:py-12">
        <div className="mx-auto max-w-7xl">
          <div className="grid items-center gap-12 lg:grid-cols-2 justify-items-center lg:justify-items-start">
            ...
            <div className="relative mx-auto max-w-md lg:max-w-lg  lg:order-2">
